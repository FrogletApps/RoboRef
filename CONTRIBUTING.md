...
RoboRef is designed to be a progressive web app that is primarily intended
...
1. RoboRef should be available from the web and quick to install even on
...
6. Sharing content between devices must be quick, reliable, and automatic. Users
   ...
   possible.
7. The job of a referee is not to enter data into our system. RoboRef is just
...
The general structure of RoboRef is motivated by creating a Progressive Web
...
Once you install dependencies, run a local instance of RoboRef in
