...
''';
  ...
  group('ChangeLogScreen Widget Tests', () {
    testWidgets('renders current version in version card and as top item in release history', (tester) async {
      ...
      expect(find.textContaining('Natural Team Sorting', findRichText: true), findsWidgets);
      expect(find.textContaining('Single Changelog Consolidation', findRichText: true), findsWidgets);
    });
