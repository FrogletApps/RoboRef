...
/// Active event details provider - reactive stream for real-time UI updates
final activeEventProvider = StreamProvider.autoDispose<Event?>((ref) {
  try {
    final db = ref.watch(databaseProvider);
    final settings = ref.watch(syncSettingsProvider);
    return db.watchEventBySku(settings.currentSku).handleError((_) => null);
  } catch (_) {
