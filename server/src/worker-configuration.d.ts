/* eslint-disable */
// Generated by Wrangler by running `wrangler types server/src/worker-configuration.d.ts` (hash: 86e7eb6091e8d1dc5bb77f3a40167ec4)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index.cf");
	}
	interface TestEnv {
		DB: D1Database;
		ENVIRONMENT: "test";
