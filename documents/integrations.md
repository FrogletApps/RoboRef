...
```
https://roboref.fyi/api/integration/v1/<SKU>/
```
...
### `https://roboref.fyi/api/integration/v1/<SKU>/verify`
...
### `https://roboref.fyi/api/integration/v1/<SKU>/users`
...
### `https://roboref.fyi/api/integration/v1/<SKU>/incidents.json`
...
### `https://roboref.fyi/api/integration/v1/<SKU>/incidents.csv`
...
### `https://roboref.fyi/api/integration/v1/<SKU>/incidents.pdf`
